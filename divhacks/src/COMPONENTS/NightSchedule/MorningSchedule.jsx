...
const MorningSchedule = () => {
  ...
  const morningTasks = [
    { name: 'Dinner', time: '7:00 PM', icon: breakfastIcon, sound: breakfastSound },
    { name: 'Brush Teeth', time: '9:00 PM', icon: brushTeethIcon, sound: brushTeethSound },
    { name: 'PJs', time: '9:30 PM', icon: getDressedIcon, sound: getDressedSound },
    { name: 'Relaxation Time', time: '9:40 PM', icon: relaxationTimeIcon, sound: relaxationTimeSound },
  ];
  ...
  return (
    <div className="morning-schedule-container">
      <h1 className="schedule-title">Night Schedule</h1>
